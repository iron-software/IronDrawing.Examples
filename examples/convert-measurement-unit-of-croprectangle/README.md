> Full guide: [Convert measurement unit of croprectangle](https://ironsoftware.com/open-source/csharp/drawing/examples/convert-measurement-unit-of-croprectangle/?utm_source=github)
